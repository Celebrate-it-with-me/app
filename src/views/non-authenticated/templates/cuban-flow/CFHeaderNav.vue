...
// Define a reactive variable to store the hash value
...
<template>
  <header
    class="header__nav-mobile lg:hidden fixed top-0 right-0 z-50 w-full"
  ...
  >
    ...
    >
      <nav v-if="menuOpen" class="mt-3 w-full flex justify-center w-full h-[calc(100vh-12%)]">
        <div
          class="border-rose-100 bg-gradient-to-b from-red-800 to-blue-800 border-y w-[96%] flex items-center justify-center rounded-md flex-col h-full"
        >
          <div
            class="flex-1 px-4 py-5 mx-auto text-white text-center flex items-center justify-center"
          >
            <ul class="space-y-2">
              <li>
          ...
          <div class="header-log flex justify-center mt-auto mb-8">
            <p class="text-5xl font-bold leading-tight font-white font-gvibes mt-2">Mis Quinces</p>
          </div>
        </div>
      </nav>
    </Transition>
    ...
    <div class="header-navigation flex items-center gap-x-4 font-Jost">
      <nav class="">
        <ul class="flex gap-x-4">
          <li
            class="cursor-pointer text-red-800 transition-colors duration-300"
            :class="{ 'text-red-500': currentHash === '#sectionHome' }"
          >
            <a href="#sectionHome">HOME</a>
          </li>
          <li
            class="cursor-pointer text-red-800 transition-colors duration-300"
            :class="{ 'text-red-500': currentHash === '#sectionSTD' }"
          >
            <a href="#sectionSTD">SAVE THE DATE</a>
          </li>
          <li
            class="cursor-pointer text-red-800 transition-colors duration-300"
            :class="{ 'text-red-500': currentHash === '#sectionItinerario' }"
          >
            <a href="#sectionItinerario">ITINERARIO</a>
          </li>
          <li
            class="cursor-pointer text-red-800 transition-colors duration-300"
            :class="{ 'text-red-500': currentHash === '#sectionSweetMemories' }"
          >
      ...
      <div class="header-log">
        <p
          class="text-5xl font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-red-800 to-blue-800 font-gvibes mt-2"
        >
          Mis Quinces
        </p>
      </div>
      <nav>
        <ul class="flex gap-x-4">
          <li
            class="cursor-pointer text-blue-800 transition-colors duration-300"
            :class="{ active: currentHash === '#sectionRSVP' }"
          >
            <a href="#sectionRSVP">RSVP</a>
          </li>
          <li
            class="cursor-pointer text-blue-800 transition-colors duration-300"
            :class="{ active: currentHash === '#sectionSong' }"
          >
            <a href="#sectionSong">CANCIONES</a>
          </li>
          <li
            class="cursor-pointer text-blue-800 transition-colors duration-300"
            :class="{ active: currentHash === '#sectionComments' }"
          >
            <a href="#sectionComments">COMENTARIOS</a>
          </li>
          <li
            class="cursor-pointer text-blue-800 transition-colors duration-300"
            :class="{ active: currentHash === '#sectionContact' }"
          >
