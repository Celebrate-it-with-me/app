    ...
    <div class="hero relative w-full h-screen overflow-hidden">
      ...
      >
        <div class="top-hero flex flex-col items-center justify-center w-full">
          <p
            class="text-5xl font-bold leading-tight leading-tight text-transparent bg-clip-text bg-gradient-to-r from-red-800 to-blue-800 font-gvibes animate__animated animate__bounceInLeft mt-2"
          >
            Isabella Canedo
          </p>
          <p
            class="text-2xl font-semibold text-dark-blue animate-fadeIn animate__animated animate__bounceInRight"
          >
            09.27.2025
          </p>
        </div>
        ...
        <div
          class="bottom-hero w-full flex flex-col items-center justify-center w-full animate__animated animate__bounce bg-white bg-opacity-50 p-10"
        >
          ...
          <div class="guest-section">
            ...
            <ul v-if="haveCompanions" class="ml-4 text-dark-blue text-sm">
