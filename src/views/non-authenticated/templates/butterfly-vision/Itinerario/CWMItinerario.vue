...
<template>
  <div id="sectionItinerario" class="relative overflow-hidden min-h-[200vh] w-full">
    ...
    <!-- Timeline content -->
    <div
      class="relative z-10 mx-auto flex justify-center w-full min-h-screen p-2 md:p-8 bg-white/60"
    >
      <div
      ...
      >
        ...
        <div class="flex flex-col justify-between h-full">
          ...
          <div class="mb-8 flex justify-between items-center w-full right-timeline">
            ...
            <div class="order-1 bg-[#baa7fb]/60 rounded-lg shadow-xl w-5/12 px-2 py-2">
          ...
          <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
            <div class="order-1 w-5/12 flex justify-center items-center">
              <img :src="DanceGif" alt="Dance" class="w-24 h-24 rounded-lg object-contain" />
            </div>
            <div class="z-20 flex items-center order-1 bg-gray-800 shadow-xl w-8 h-8 rounded-full">
