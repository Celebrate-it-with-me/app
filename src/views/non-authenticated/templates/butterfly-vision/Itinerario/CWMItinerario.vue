      ...
      <div class=" flex flex-col justify-between h-full">
        <div class="mb-8 flex justify-between items-center w-full right-timeline">
          ...
          <div class="order-1 bg-[#baa7fb] rounded-lg shadow-xl w-5/12 px-2 py-2">
            ...
            <p class="text-sm font-medium leading-snug tracking-wide text-white text-opacity-100">7:00pm-8:00pm</p>
          </div>
        </div>
        ...
        <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
          ...
          <div class="order-1 bg-[#baa7fb] rounded-lg shadow-xl w-5/12 px-2 py-2">
            ...
            <p class="text-sm font-medium leading-snug tracking-wide text-white text-opacity-100">8:00pm-9:30pm</p>
          </div>
        </div>
        ...
        <div class="mb-8 flex justify-between items-center w-full right-timeline">
          ...
          <div class="order-1 bg-[#baa7fb] rounded-lg shadow-xl w-5/12 px-2 py-2">
            ...
            <p class="text-sm leading-snug tracking-wide text-white text-opacity-100">9:30pm-10:30pm</p>
          </div>
        </div>
        ...
        <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
          ...
          <div class="order-1 bg-[#baa7fb] rounded-lg shadow-xl w-5/12 px-2 py-2">
            ...
            <p class="text-sm font-medium leading-snug tracking-wide text-white text-opacity-100">10:30pm-11:00pm</p>
          </div>
        </div>
