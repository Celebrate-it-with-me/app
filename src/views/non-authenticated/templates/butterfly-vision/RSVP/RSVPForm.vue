...
<template>
  <Form :validation-schema="rsvpValidationSchema" class="max-w-md mx-auto flex flex-col gap-5">
    <div class="relative z-0 w-full mb-5 group">
      ...
      />
      <label
        class="peer-focus:font-medium absolute text-lg ml-2 text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-rose-400 peer-focus:dark:text-rose-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
      >
        Name
      </label>
    </div>
    <div class="relative z-0 w-full mb-5 group">
      ...
      />
      <label
        class="peer-focus:font-medium absolute text-lg ml-2 text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-rose-400 peer-focus:dark:text-rose-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
        >Email</label
      >
    </div>
      ...
      <fieldset class="flex flex-row justify-between gap-4">
        ...
        <div class="flex items-center mb-4">
          <label class="flex items-center space-x-2 cursor-pointer">
            ...
            >
              <span class="w-2.5 h-2.5 bg-rose-600 rounded-full hidden peer-checked:block"> </span>
            </span>
    ...
    <div v-if="hasCompanions" class="relative z-0 w-full mb-5 group">
      <SelectField
      ...
      <div class="w-full flex justify-end mt-2">
        <span class="text-gray-500 underline cursor-pointer text-xs" @click="openCompanionsModal"
          >Details</span
        >
      </div>
    </div>
