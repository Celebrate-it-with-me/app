...
import GuestsTable from '@/modules/guests/components/GuestsTable.vue'
import NoGuests from '@/modules/guests/components/NoGuests.vue'
...
const { loading, hasGuests } = useGuestsController()
