...
<template>
  ...
  >
    <!-- Progress Indicator -->
    <div
      class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 mb-6 border border-purple-200"
    >
      ...
      <div class="w-full bg-white rounded-full h-3 shadow-inner">
        ...
        >
          <span v-if="completionPercentage > 20" class="text-xs text-white font-bold"
      ...
      <p class="text-xs text-gray-600 mt-2">
        {{
          completionPercentage < 100
            ? 'Complete all fields to save your memory'
            : 'Ready to save! 🎉'
        }}
      </p>
    </div>
    ...
    <div
      v-if="hasContent"
      class="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl p-3 mb-6"
    >
    ...
    >
      <div
        v-if="showPreview"
        class="bg-white rounded-2xl p-6 border-l-4 border-purple-500 shadow-lg mb-6"
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <!-- Preview Image -->
          <div
            class="relative overflow-hidden rounded-xl aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200"
          >
            <img
          ...
          <div class="flex flex-col justify-between">
            <div class="flex items-start justify-between border-b border-gray-100 pb-4 mb-4">
              ...
              <span
                v-if="memory.year"
                class="ml-3 px-4 py-1.5 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full text-sm font-semibold shadow-md"
              >
                {{ memory.year }}
              </span>
            </div>
    ...
    <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm mb-6">
      ...
      >
        <div class="space-y-4">
          <div
            class="w-20 h-20 mx-auto bg-purple-100 rounded-full flex items-center justify-center transition-transform"
          ...
          <div>
            <p class="text-lg font-semibold text-gray-900 mb-1">
              ...
              <span class="text-purple-600 hover:text-purple-700">browse</span>
            </p>
      ...
      <div v-else class="relative group">
        <div class="relative overflow-hidden rounded-2xl aspect-video bg-gray-100">
          ...
          <div
            class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center gap-4"
          >
            <button
              type="button"
        ...
        <div
          v-if="selectedFile"
          class="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg"
        >
          <div class="flex items-center gap-2">
            <svg
    ...
    <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm mb-6">
      ...
      <div class="space-y-6">
        ...
        <div class="space-y-2">
          ...
          <p v-else-if="!errors.title" class="text-xs text-gray-500">
            Give this memory a meaningful title
          </p>
        </div>
        ...
        <div class="space-y-2">
          ...
          <p v-else class="text-xs text-gray-500">
            Enter the year (e.g., 2024) or age (e.g., 5 years old) when this happened
          </p>
        </div>
        ...
        <div class="space-y-2">
          <label class="flex items-center justify-between">
            ...
            <span
              ...
              :class="memory.description?.length > 500 ? 'text-red-500' : 'text-gray-500'"
            >
    ...
    <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm mb-6">
      ...
      <div
        class="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 rounded-xl p-6"
      >
        <div class="flex items-start gap-4">
          <div class="flex-1">
            <h4 class="font-bold text-gray-900 mb-1 flex items-center gap-2">Memory Visibility</h4>
    ...
    <!-- Form Actions -->
    <div
      class="flex items-center justify-end gap-3 bg-white rounded-2xl p-5 border border-gray-200 shadow-sm"
    >
      <CButton
        v-if="isEditing"
        variant="danger"
      ...
      <CButton variant="secondary" size="md" class="flex items-center px-6" @click="cancelEdit">
