...
import DressCodeService from '@/modules/dress-code/services/DressCodeService'
...
export const useDressCodeStore = defineStore('dressCodeStore', {
  ...
  actions: {
    ...
    async deleteDressCode(dressCodeId) {
      try {
        const response = await DressCodeService.deleteDressCode({
          eventId: useUserStore().activeEvent,
          dressCodeId
        })
        ...
        console.error('Error deleting dress code:', error)
        throw error
      }
    }
  },
