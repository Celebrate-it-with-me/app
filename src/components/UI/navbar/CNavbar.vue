        ...
        <template v-for="(link, index) in selfLinks" :key="index">
          <a
            ...
            :class="[
              ...
              link.isActive ? 'text-primary' : 'text-gray-700 dark:text-gray-300 hover:text-primary'
            ]"
      ...
      <div class="hidden md:flex items-center gap-4">
        <slot name="extra">
          <RouterLink v-if="loginLink" :to="`/${loginLink}`">
            <a class="text-sm text-gray-600 dark:text-gray-300 hover:text-primary">Login</a>
          </RouterLink>
