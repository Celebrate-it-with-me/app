    ...
    <div class="flex flex-col max-h-[80vh]">
      <div class="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div v-if="!isBulk && singleGuest" class="space-y-4">
          <div
            class="bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-xl p-4"
          >
        ...
        <div v-else-if="isBulk" class="space-y-3">
          <div
            class="max-h-48 overflow-y-auto border border-gray-100 dark:border-gray-700 rounded-xl divide-y divide-gray-100 dark:divide-gray-700"
          >
            <div
        ...
        <div class="space-y-3">
          ...
          <div class="flex flex-wrap gap-4">
            <label
              v-for="method in ['email', 'sms', 'both']"
              :key="method"
            ...
            >
              ...
              />
              <span
                class="ml-2 text-sm text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-200 capitalize"
              >
                {{ method }}
              </span>
            </label>
        ...
        <div
          v-if="contextMessage"
          class="p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-lg"
        >
