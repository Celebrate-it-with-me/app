...
const prevPhoto = () => {
  currentPhoto.value = currentPhoto.value === 0 ? props.images.length - 1 : currentPhoto.value - 1
}

const nextPhoto = () => {
  currentPhoto.value = currentPhoto.value === props.images.length - 1 ? 0 : currentPhoto.value + 1
}
