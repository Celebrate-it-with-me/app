...
<template>
  <div class="flex items-center">
    <label class="inline-flex items-center cursor-pointer">
      ...
      <div
        class="relative w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-focus:ring-4
              ...
              dark:border-gray-600 peer-checked:bg-yellow-400 dark:peer-checked:bg-yellow-400"
      ></div>
