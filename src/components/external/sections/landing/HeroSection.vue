      ...
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="text-center lg:text-left space-y-8 animate-fadeIn">
          ...
          <div class="flex flex-wrap gap-3 justify-center lg:justify-start">
            <div
              class="flex items-center px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full border border-gray-200/50 dark:border-gray-700/50 shadow-sm"
            >
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <a
              href="#features"
              class="group relative px-8 py-4 bg-gradient-to-r from-primary to-secondary text-white font-bold text-lg rounded-2xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 overflow-hidden"
            >
              <span class="relative z-10">Start Planning Free</span>
              <div
                class="absolute inset-0 bg-gradient-to-r from-primary-dark to-secondary-dark opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              ></div>
            </a>
            <a
              href="#pricing"
          ...
          <div class="flex items-center justify-center lg:justify-start gap-6 pt-4">
            <div class="flex -space-x-3">
              <img
                ...
                class="w-10 h-10 rounded-full border-3 border-white shadow-lg"
                alt="User"
              />
              <img
              ...
              />
              <div
                class="w-10 h-10 rounded-full border-3 border-white shadow-lg bg-gradient-to-r from-primary to-secondary flex items-center justify-center"
              >
            ...
            <div class="text-left">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400">5,000+ happy customers</p>
            </div>
          </div>
        </div>
        ...
        <div class="relative animate-slideInRight">
          ...
          <div class="relative">
            <!-- Floating Cards -->
            <div
              class="absolute -top-8 -left-8 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-gray-200/50 dark:border-gray-700/50 animate-float"
            >
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-semibold text-gray-900 dark:text-white text-sm">Event Created!</p>
                  <p class="text-xs text-gray-500 dark:text-gray-400">Planning made easy</p>
                </div>
              </div>
            </div>

            <div
              class="absolute -bottom-8 -right-8 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-gray-200/50 dark:border-gray-700/50 animate-float"
              style="animation-delay: 1s"
            >
              <div class="flex items-center gap-3">
                <div
                ...
                <div>
                  <p class="font-semibold text-gray-900 dark:text-white text-sm">Budget Saved</p>
                  <p class="text-xs text-gray-500 dark:text-gray-400">$2,500 under budget</p>
                </div>
              </div>
            </div>
            ...
            <!-- Main Image -->
            <div
              class="relative overflow-hidden rounded-3xl shadow-2xl transform hover:scale-105 transition-transform duration-700"
            >
              <div
              ...
              <img
                :src="HeroImage"
                alt="Beautiful event venue decorated for a celebration"
                class="w-full h-96 lg:h-[500px] object-cover"
                loading="eager"
              />
              <!-- Overlay Content -->
              <div class="absolute bottom-6 left-6 right-6 z-20">
                <div class="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl p-4">
                  <div class="flex items-center justify-between">
                    <div>
                      <p class="font-semibold text-gray-900 dark:text-white">Dream Quinceañera</p>
                      <p class="text-sm text-gray-600 dark:text-gray-400">
                        150 guests • $8,500 budget
                      </p>
                    </div>
                    <div class="flex items-center gap-1">
                      <div class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                      <span class="text-sm font-medium text-green-600">Live Planning</span>
                    </div>
                  </div>
                </div>
              </div>
...
<script setup>
import HeroImage from '@/assets/images/external/hero-venue.jpg'
