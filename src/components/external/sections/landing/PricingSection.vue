<template>
  <section class="py-half px-4 bg-white dark:bg-gray-900 relative">
    ...
    <div class="absolute left-0 top-1/3 w-72 h-72 bg-pink-50 dark:bg-pink-900/10 rounded-full blur-3xl opacity-40 -z-10"></div>
    <div class="absolute right-0 bottom-1/4 w-64 h-64 bg-purple-50 dark:bg-purple-900/10 rounded-full blur-3xl opacity-40 -z-10"></div>

    <div class="max-w-7xl mx-auto text-center mb-12 animate-fadeIn">
      <CHeading :level="2" weight="bold" class="mb-3">
