<template>
  ...
  >
    ...
    <div class="absolute inset-0 overflow-hidden">
      <div
        class="absolute -top-40 -left-40 w-96 h-96 bg-gradient-to-r from-accent/10 to-primary/10 rounded-full blur-3xl opacity-60 animate-pulse"
      ></div>
      <div
      ...
      <div
        class="absolute top-20 right-20 w-6 h-6 bg-primary/20 rounded-lg animate-bounce"
      ...
      <div
        class="absolute bottom-32 left-16 w-4 h-4 bg-secondary/30 rounded-full animate-pulse"
    ...
    <div class="relative z-10 max-w-7xl mx-auto">
      ...
      <div class="text-center mb-20 animate-fadeIn">
        <div
          class="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-accent/10 to-primary/10 border border-accent/20 backdrop-blur-sm mb-6"
        >
        ...
        >
          Inspiring Event
          <span
            class="block bg-gradient-to-r from-accent via-primary to-secondary bg-clip-text text-transparent"
            >Gallery</span
          >
        </CHeading>
        ...
        <div class="absolute top-1/2 -left-4 sm:-left-6 transform -translate-y-1/2 z-20">
          ...
          >
            <svg
              ...
              class="h-6 w-6 text-gray-700 dark:text-gray-300 group-hover:text-primary transition-colors duration-300"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            >
              ...
              >
                ...
                <div class="relative overflow-hidden">
                  ...
                  <!-- Floating badge -->
                  <div
                    class="absolute top-4 right-4 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full px-3 py-1 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0"
                  >
                ...
                >
                  <div
                    class="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl p-4 shadow-xl"
                  >
